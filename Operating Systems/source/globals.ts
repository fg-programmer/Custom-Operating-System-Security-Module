...
const NUM_PARTITIONS: number = 0x03;      
const PARTITION_SIZE: number = 0x0100;
const MEMORY_SIZE: number = PARTITION_SIZE * NUM_PARTITIONS;
...
var _Disk: TSOS.Disk;
var _DiskDisplay: TSOS.DiskDisplay = null;
...
var _CurrentPCB: TSOS.PCB | null = null;
