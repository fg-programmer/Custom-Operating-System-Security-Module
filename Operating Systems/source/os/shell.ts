    ...
    export class Shell {
        ...
        public init() {
            ...
            sc = new ShellCommand(
                this.shellFormat,
                'format',
                'initialize all blocks in all sector tracks'
            );
            this.commandList[this.commandList.length] = sc;
            ...
            sc = new ShellCommand(
                this.shellRename,
                'rename',
                '<current filename> <new filename> - Runs the specificed program'
            );
            this.commandList[this.commandList.length] = sc;
            ...
            sc = new ShellCommand(
                this.shellCopy,
                'copy',
                '<existing filename> <new filename> - Copy a file'
            );
            this.commandList[this.commandList.length] = sc;
            ...
            sc = new ShellCommand(
                this.shellFormat,
                'format',
                '-quick: Initalize first four data blocks'
            );
            this.commandList[this.commandList.length] = sc;
            ...
            sc = new ShellCommand(
                this.shellList,
                'ls',
                '-a: List all hidden files and their creation date and size'
            );
            this.commandList[this.commandList.length] = sc;
            ...
            sc = new ShellCommand(
                this.shellAlias,
                'alias',
                '<command1> <command2> - alias shell commands'
            );
            this.commandList[this.commandList.length] = sc;
            sc = new ShellCommand(
                this.shellLogin,
                'login',
                '<user> <pass> logs in user'
            );
            this.commandList[this.commandList.length] = sc;
            ...
            sc = new ShellCommand(
                this.shellUseradd,
                'useradd',
                '<user> <pass> adds user credentials'
            );
            this.commandList[this.commandList.length] = sc;
        ...
        public shellLogin(args: string[]): void {
            if (args.length < 2) {
        ...
        public shellLogout(): void {
            _SecurityManager.logout();
            _StdOut.putText("Logged out");
        }
        public shellUseradd(args: string[]): void {
        ...
        public shellList(args: string[]): void {
            try {
