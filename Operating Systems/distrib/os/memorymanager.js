...
(function (TSOS) {
    class MemoryManager {
        ...
        pcbTable;
        partitionMap;
        constructor(partitionSize = PARTITION_SIZE) {
            this.pidCounter = 0;
            this.partitionSize = partitionSize;
            this.pcbTable = new Map();
        ...
        loadProgram(hexBytes) {
            ...
            if (sanitized.length > this.partitionSize) {
                throw new Error(`MemoryManager program size ${sanitized.length} exceeds available memory ${this.partitionSize}.`);
            }
            ...
            try {
                ...
                pcb = new TSOS.PCB(pid, base, limit, 0, 0, 0, 0, 0, "Resident");
                ...
                pcb = new TSOS.PCB(pid, 0, 0, 0, 0, 0, 0, 0, "Resident", 0, 0, undefined, "Hard Drive", 0, 0, tsb, true);
